...
public class Blue21Safe extends CommandOpMode {
    ...
    private final Pose CollectGateTurn = new Pose(19.8, 59.5, Math.toRadians(150));
    private final Pose CollectGate = new Pose(12.3, 59.4, Math.toRadians(150));


    private final Pose GateShootLeave = new Pose(15.5, 57.5, Math.toRadians(205));
    ...
    private final Pose Collect1Control = new Pose(30.5, 86, Math.toRadians(0));
...
//    private final Pose Score3 = new Pose(62, 100, Math.toRadians(250));
    ...
    private Path Shoot1;
    private PathChain IntakeGate1, IntakeGate2, IntakeGateCycle, GateScoreFull, GateScoreFull1;
