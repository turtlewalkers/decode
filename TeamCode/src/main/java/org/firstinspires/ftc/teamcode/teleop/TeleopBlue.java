...
public class TeleopBlue extends OpMode {
    ...
    public void loop() {
        double multiplier = 1;
        if (gamepad1.left_trigger != 0) multiplier = 0.1;
        follower.setTeleOpDrive(-gamepad1.left_stick_y * multiplier, -gamepad1.left_stick_x * multiplier, -gamepad1.right_stick_x * multiplier, false, Math.PI / 2.0);
        follower.update();
