...
public class BlueAuto15 extends LinearOpMode {
    ...
    private final Pose GotoGate = new Pose(20, 70, Math.toRadians(180));
    private final Pose OpenGate = new Pose(10, 70, Math.toRadians(180));
    private final Pose LeaveGate = new Pose(50, 65, Math.toRadians(180));
    ...
    public void runOpMode() {
        ...
        GateOpen = follower.pathBuilder()
                .addPath(new BezierLine(GotoGate, OpenGate))
                .setLinearHeadingInterpolation(GotoGate.getHeading(), OpenGate.getHeading())
                .build();
        ...
        Goto4Part1 = follower.pathBuilder()
                .addPath(new BezierCurve(ScorePosition, Grab4Setup))
                .setLinearHeadingInterpolation(ScorePosition.getHeading(), Grab4Setup.getHeading())
                .build();
        ...
        try {
            ...
            followPath(ToGate, false);
            followPath(GateOpen, true);
            followPath(GateLeave, true);
            ...
            followPath(Goto4Part1, false);
            followPath(Goto4Part2, true);
            followPath(Goto4, true);
            followPath(Shoot4, true);
