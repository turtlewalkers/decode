...
public class Blue24 extends CommandOpMode {
    ...
    public void initialize() {
        ...
        new Intake(hardwareMap, Math.sqrt((shooterX -follower.getPose().getX())*(shooterX -follower.getPose().getX()) + (shooterY -follower.getPose().getY())*(shooterY -follower.getPose().getY())));
        this.resetRuntime();
        buildpaths();
