...
public class Constants {
    ...
    public static FollowerConstants followerConstants = new FollowerConstants()
            ...
            .drivePIDFCoefficients(new FilteredPIDFCoefficients(4.00067420,0.00000000,0.0000027,0.6,0.007))
            .centripetalScaling(0.00034)
            .predictiveBrakingCoefficients(new PredictiveBrakingCoefficients(0.05, 0.1183, 0.001301411, 0.25));
    ...
    public static PathConstraints pathConstraints2 = new PathConstraints(0.995, 0, 1.4, 0.8);
